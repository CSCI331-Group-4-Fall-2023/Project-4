...
int main() {
    ...
    // Test cases
    testSearch(blockSearcher, 56301, "56301,Saint Cloud,MN,Stearns,45.541,-94.1819");
    testSearch(blockSearcher, 61072, "61072,Rockton,IL,Winnebago,42.4544,-89.0887");
    testSearch(blockSearcher, 1453, "1453,Leominster,MA,Worcester,42.5274,-71.7563");
